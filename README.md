...
ToolPurposePython (Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn)Data cleaning, EDA, K-Means clusteringSQL (SQL Server)Campaign analysis and aggregationsPower BIInteractive dashboard and visualization
📁 Folder Structure
